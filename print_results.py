...
#                                                                             
# PROGRAMMER: Grace Ibukuoluwa Fadahunsi
# DATE CREATED: Aug 10, 2021
# REVISED DATE: Aug 11, 2021
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary statistics (percentages) for CNN Model Architecture: ",model.upper(), 
          "***")
    for key in results_stats_dic:

        #print ("firstkey character: {} , key: {}".format(key[0], key))
        if key[0] == 'p':
